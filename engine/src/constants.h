...
#endif
#define TIME_EXPECT_GAME_LENGTH 70
#define TIME_THRESH_MOVE_PROP_SYSTEM 65
#define TIME_PROP_MOVE_FACTOR 0.07f
#define TIME_INCREMENT_FACTOR 0.7f
#define TIME_BUFFER_FACTOR 30.0f
const int TIME_NB_COEFFICIENTS = 6;
const double TIME_COEFF[TIME_NB_COEFFICIENTS] = { 1.00996880e-02,  1.25474941e-03, -5.99143961e-05,  1.06198535e-06, -8.19488793e-09,  2.29058196e-11};
