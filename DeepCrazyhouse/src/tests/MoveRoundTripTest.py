...
import unittest
from DeepCrazyhouse.src.domain.crazyhouse.output_representation import policy_to_move, move_to_policy, policy_to_moves, policy_to_best_move
...
class MoveRoundTripTest(unittest.TestCase):
    ...
    def test_loaded_dataset_white_move(self):
        ...
        s_idcs_val, x_val, yv_val, yp_val, pgn_datasets_val = load_pgn_dataset(dataset_type='test', part_id=0,
                                                                               print_statistics=True,
                                                                               print_parameters=True, normalize=True)
        ...
        self.assertTrue(mv_converted_is_legal,
