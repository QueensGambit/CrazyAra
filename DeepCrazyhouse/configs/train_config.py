...
class TrainConfig:
    ...
    batch_size: int = int(64 / div_factor)
    ...
    name_initials: str = "RM"

    nb_parts: int = None

    normalize: bool = False #True  # define whether to normalize input data to [01]
    ...
    select_policy_from_plane: bool = False # True
