...
from deep_crazy_house.src.model.crazy_house.output_representation import get_move_planes
from deep_crazy_house.src.model.crazy_house.move_presentation import get_move_representation
